...
export const Header = () => {
  ...
  const headerHeight = isTopBannerVisible 
    ? (isScrolled ? topBannerHeight + navHeightScrolled : topBannerHeight + navHeightDefault) 
    : (isScrolled ? navHeightScrolled : navHeightDefault);
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      if (currentScrollY <= scrollThreshold) {
        setIsTopBannerVisible(prevScrollY > currentScrollY || currentScrollY <= 2);
      } else {
