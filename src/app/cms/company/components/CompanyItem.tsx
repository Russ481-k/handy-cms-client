  ...
  return (
    <>
      ...
      <ConfirmDialog
        ...
        title="입주기업 삭제"
        description="정말로 이 입주기업을 삭제하시겠습니까?"
        confirmText="삭제"
        cancelText="취소"
