...
var createInitialAdmin = function () { return __awaiter(void 0, void 0, void 0, function () {
    var hashedPassword;
    return __generator(this, function (_a) {
        hashedPassword = hashPassword("0000");
        return [2 /*return*/, "\n    INSERT INTO users (uuid, username, name, password, email, role, status) \n    VALUES (UUID(), 'admin', 'Administrator', '".concat(hashedPassword, "', 'admin@example.com', 'admin', 'active')\n  ")];
    });
}); };
